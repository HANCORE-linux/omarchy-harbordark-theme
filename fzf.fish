...
set -l color04 '#8484a0'
set -l color05 '#a7a6c6'
set -l color06 '#99a4af'
set -l color07 '#e6efff'
set -l color08 '#929292'
set -l color09 '#f44336'
set -l color0A '#e75a50'
set -l color0B '#a99b7a'
set -l color0C '#8484a0'
set -l color0D '#a7a6c6'
set -l color0E '#99a4af'
set -l color0F '#e6efff'
